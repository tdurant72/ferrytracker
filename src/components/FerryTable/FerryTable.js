          ...
          <Table style={styles.table}>
            <TableHead>
              <TableRow className={classes.tableHeader}>
                <TableCell
                  className={(classes.tableHeaderFont, classes.onSmallTable)}
                >
                  Ferry Terminal
                </TableCell>
                <TableCell
                ...
                >
                  <TableCell className={classes.onSmallTable}>
                    <span
                      ...
                      onClick={this.onHandleTerminalTableView.bind(
                        this,
                  ...
                  >
                    <span
                      ...
                      onClick={this.onHandleTableView.bind(
                        this,
                        boat.geometry.coordinates[1],
                        boat.geometry.coordinates[0]
                      )}
                  ...
                  <TableCell className={classes.onSmallTable}>
                    {boat.properties.SOG === "0 knots" ? "docked" : " underway"}
                  </TableCell>
                  <TableCell className={classes.onSmallTable}>
